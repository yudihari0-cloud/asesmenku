...
export const sheetsStore = {
  ...
  async insert(col, doc) {
    ...
    await gapi(`/values/${encodeURIComponent(col + '!A1')}?valueInputOption=RAW&await gapi(`/values/${encodeURIComponent(col + '!A1')}?valueInputOption=RAW&insertDataOption=INSERT_ROWS`, {=INSERT_ROWS`, {
      method: 'POST',
