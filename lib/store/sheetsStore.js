...
export const SHEETS_SCHEMA = {
  users: ['id', 'role', 'nama', 'username', 'nisn', 'kelasId', 'sekolahId', 'namaSekolah', 'wa', 'nip', 'jabatan', 'foto', 'pwHash', 'admin', 'createdAt'],
  sekolah: ['id', 'nama', 'alamat', 'logo', 'masaAktifSampai', 'createdAt'],
